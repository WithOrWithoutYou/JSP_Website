...
%>
	...
	<div class="container">
		<div class="row">
				...
				<table class="table table-striped"    style="text-align: center; border: 1px solid #dddddd; width : 1200px;"  >
					<thead>
						<tr>
		...
		<a href = "board.jsp" class="btn btn-primary"> 목록 </a>
				...
				%>
					...
					<a href="deleteboardAction.jsp?bbsID=<%=bbsID%>" class = "btn btn-danger"> 삭제 </a>
				<%
					}
				%>
	</div>
